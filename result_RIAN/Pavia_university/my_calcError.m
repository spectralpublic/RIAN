function [overall_accuracy,kappa_accuracy,average_accuracy,class_accuracy,errorMatrix] = my_calcError( trueLabelling, segLabelling, labels )
% by: sun hao
% trueLabelling: N*1;max = maxclasses,min = 1
% segLabelling: N*1;max = maxclasses,min = 1
% labels: [1:maxclasses] 
% 
