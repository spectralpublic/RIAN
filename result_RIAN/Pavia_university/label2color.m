...
%         map=[0 0 255;255 100 0;0 255 134;150 70 150; 100 150 255;60 90 114;255 255 125;255 0 255;100 0 255;1 170 255;0 255 0;175 175 82;100 190 56;140 67 46;115 255 172;255 255 0];
            map=[140 67 46;0 0 255;255 100 0;0 255 123;164 75 155;101 174 255;118 254 172; 60 91 112;213 26 33;255 255 125;255 0 255;100 0 255;0 172 254;0 255 0;171 175 80;101 193 60];
        for i=1:w
            for j=1:h
                switch(label(i,j))
                    case(1)
    ...
    case 'houston'
         map=[139 0 0; 255 100 0; 255 0 0;
             230,230,250; 255,255,0;85,107,47;
             173,255,47;34,139,34;64,224,208;
             0,191,255;176,196,222;0,0,205;
             138,43,226;255,0,255;255,192,203];
         for i=1:w
            for j=1:h
                switch(label(i,j))
                    case(1)
