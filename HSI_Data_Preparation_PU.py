...
from utils_PU import patch_size, convertToOneHot, Prepare_data, Database
...
#scipy.io.savemat(os.path.join(DATA_PATH, 'AllData_Original' +'_'+str(patch_size) + '.mat'),All_data)
